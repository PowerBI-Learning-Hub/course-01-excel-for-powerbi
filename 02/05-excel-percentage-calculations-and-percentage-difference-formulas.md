...
## Sales & Discount Dataset

| Product      | Unit Price | Quantity | Discount % | April Sales | May Sales |
| ------------ | ---------- | -------- | ---------- | ----------- | --------- |
| Bike Frame   | 250        | 10       | 10%        | 5000        | 5750      |
| Helmet       | 45         | 25       | 5%         | 2200        | 2600      |
| Gloves       | 20         | 40       | 8%         | 1800        | 2100      |
| Water Bottle | 12         | 50       | 12%        | 950         | 1100      |
| Tire Pump    | 35         | 15       | 10%        | 1500        | 1725      |
...
```excel
=(MaySales-AprilSales)/AprilSales
```
...
# Mini Analyst Workflow

```text
1. Create raw data table
2. Build subtotal formulas
3. Apply discount calculations
4. Use percentage formatting
5. Calculate growth percentages
6. Lock fixed references with F4
7. AutoFill formulas downward
8. Validate final numbers
```
